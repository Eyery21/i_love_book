 ...
 */
final class Version20250306093609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series ADD CONSTRAINT FK_3A10012D514956FD FOREIGN KEY (collection_id) REFERENCES collections (id)');
