 ...
 */
final class Version20250309100337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series ADD previous_series_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE series ADD CONSTRAINT FK_3A10012D550A1E9D FOREIGN KEY (previous_series_id) REFERENCES series (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series DROP FOREIGN KEY FK_3A10012D550A1E9D');
        $this->addSql('ALTER TABLE series DROP previous_series_id');
    }
}
