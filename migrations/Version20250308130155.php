 ...
 */
final class Version20250308130155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE collections_series RENAME INDEX fk_39d6e3665278319c TO IDX_39D6E3665278319C');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE collections_series RENAME INDEX idx_39d6e3665278319c TO FK_39D6E3665278319C');
