 ...
 */
final class Version20250308125914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_39D6E366242C7AD2 ON collections_series (collections_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_39D6E366242C7AD2 ON collections_series');
        $this->addSql('ALTER TABLE collections_series RENAME INDEX idx_39d6e3665278319c TO fk_series');
