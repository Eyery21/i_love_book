 ...
 */
final class Version20250309101529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series RENAME INDEX fk_3a10012d550a1e9d TO IDX_3A10012D550A1E9D');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series RENAME INDEX idx_3a10012d550a1e9d TO FK_3A10012D550A1E9D');
    }
}
