 ...
 */
final class Version20250307085840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series DROP FOREIGN KEY FK_3A10012D514956FD');
        $this->addSql('DROP INDEX IDX_3A10012D514956FD ON series');
        $this->addSql('ALTER TABLE series DROP collection_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series ADD collection_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE series ADD CONSTRAINT FK_3A10012D514956FD FOREIGN KEY (collection_id) REFERENCES collections (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_3A10012D514956FD ON series (collection_id)');
    }
}
